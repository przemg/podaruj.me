...
export function ListCard({
  ...
  return (
    <Link
      ...
      className={`group relative flex h-full flex-col overflow-hidden rounded-2xl bg-white/80 p-5 shadow-sm backdrop-blur-sm ring-1 ring-landing-text/[0.04] transition-all duration-200 hover:shadow-lg hover:ring-landing-text/[0.08] hover:-translate-y-0.5 active:scale-[0.98] ${isClosed ? "opacity-60 grayscale-[30%]" : ""}`}
    >
      ...
      <div className="mt-auto flex items-center gap-1.5 border-t border-landing-text/[0.04] pt-3 text-xs text-landing-text-muted">
