        ...
        <div ref={revealRef} className="mt-16">
          ...
          */}
          ...
          <div className="hidden min-[1000px]:grid min-[1000px]:grid-cols-3 min-[1000px]:gap-4">
            ...
            <div className="scroll-reveal-scale col-span-2 flex flex-row overflow-hidden rounded-2xl border border-gray-200/80 bg-white shadow-lg transition-all hover:shadow-xl">
          ...
          <div className="hidden min-[768px]:flex min-[768px]:flex-col min-[768px]:gap-4 min-[1000px]:hidden">
            ...
            <div className="scroll-reveal-scale flex flex-row overflow-hidden rounded-2xl border border-gray-200/80 bg-white shadow-lg transition-all hover:shadow-xl">
              <div className="flex flex-1 flex-col p-6">
          ...
          <div className="flex flex-col gap-4 min-[768px]:hidden">
            ...
            <div className="scroll-reveal-scale flex flex-col overflow-hidden rounded-2xl border border-gray-200/80 bg-white shadow-lg transition-all hover:shadow-xl min-[600px]:flex-row">
