      ...
      <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
        ...
        {/*
          Desktop (>=1000px): 3-col grid
            ...
            Row 2: 3 small cards
          Below 1000px: single column stacked
        */}
        <div
          ref={revealRef}
        ...
        >
          ...
          <div className="scroll-reveal-scale flex flex-col overflow-hidden rounded-2xl border border-white/10 bg-white/[0.07] backdrop-blur-sm transition-all hover:border-white/20 hover:bg-white/10 min-[1000px]:col-span-2 min-[1000px]:flex-row">
            ...
            <div className="flex flex-1 flex-col p-6">
              ...
              <div className="mt-auto flex justify-center pt-6 min-[1000px]:hidden">
                <div className="flex gap-3">
                  <div className="flex flex-col items-center rounded-xl border border-landing-coral/30 bg-white/10 px-3 py-3">
                    <div className="flex h-8 w-8 items-center justify-center rounded-full bg-landing-coral/20">
                      <HelpCircle className="h-4 w-4 text-landing-coral" />
                    </div>
                    <div className="mt-2 space-y-1">
                      <div className="h-1.5 w-12 rounded-full bg-landing-coral/30" />
                  ...
                  <div className="flex flex-col items-center rounded-xl border-2 border-landing-mint/50 bg-white/15 px-3 py-3 shadow-lg shadow-landing-mint/10">
                    <div className="flex h-8 w-8 items-center justify-center rounded-full bg-landing-mint/20">
                      <Eye className="h-4 w-4 text-landing-mint" />
                    </div>
                    <div className="mt-2 space-y-1">
                      <div className="h-1.5 w-12 rounded-full bg-landing-mint/40" />
                      <div className="h-4 w-14 rounded-full bg-landing-mint text-center text-[8px] leading-4 font-bold text-white">Active</div>
                    </div>
                  </div>
                  <div className="flex flex-col items-center rounded-xl border border-landing-lavender/30 bg-white/10 px-3 py-3">
                    <div className="flex h-8 w-8 items-center justify-center rounded-full bg-landing-lavender/20">
                      <EyeOff className="h-4 w-4 text-landing-lavender" />
                    </div>
                    <div className="mt-2 space-y-1">
                      <div className="h-1.5 w-12 rounded-full bg-landing-lavender/30" />
                      <div className="h-1 w-8 rounded-full bg-white/10" />
                    </div>
                  </div>
                </div>
            ...
            <div className="hidden items-center justify-center border-l border-white/10 bg-white/[0.05] px-6 min-[1000px]:flex min-[1000px]:w-[280px] min-[1000px]:shrink-0">
              <div className="flex w-full flex-col gap-3">
                <div className="flex w-full flex-row items-center gap-3 rounded-xl border border-landing-coral/30 bg-white/10 px-3 py-3">
                  <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-landing-coral/20">
                    <HelpCircle className="h-4 w-4 text-landing-coral" />
                  </div>
                  <div className="space-y-1">
                    <div className="h-1.5 w-20 rounded-full bg-landing-coral/30" />
                    <div className="h-1 w-14 rounded-full bg-white/10" />
                  </div>
                </div>
                <div className="flex w-full flex-row items-center gap-3 rounded-xl border-2 border-landing-mint/50 bg-white/15 px-3 py-3 shadow-lg shadow-landing-mint/10">
                  <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-landing-mint/20">
                    <Eye className="h-4 w-4 text-landing-mint" />
                  </div>
                  <div className="flex-1 space-y-1">
                    <div className="h-1.5 w-20 rounded-full bg-landing-mint/40" />
                    <div className="h-4 w-16 rounded-full bg-landing-mint text-center text-[8px] leading-4 font-bold text-white">Active</div>
                  </div>
                </div>
                <div className="flex w-full flex-row items-center gap-3 rounded-xl border border-landing-lavender/30 bg-white/10 px-3 py-3">
                  <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-landing-lavender/20">
                    <EyeOff className="h-4 w-4 text-landing-lavender" />
                  </div>
                  <div className="space-y-1">
                    <div className="h-1.5 w-20 rounded-full bg-landing-lavender/30" />
                    <div className="h-1 w-14 rounded-full bg-white/10" />
                  </div>
                </div>
              </div>
          ...
          {/* Cards 3-5: Small feature cards — always 3 in a row on tablet+ */}
