...
export function Features() {
  ...
  return (
    <section id="features" className="relative overflow-hidden bg-gradient-to-br from-landing-peach-wash via-white to-landing-lavender-wash py-20 sm:py-28">
        ...
        <div ref={revealRef} className="mt-16">
          ...
          */}
          ...
          <div className="hidden min-[1000px]:grid min-[1000px]:grid-cols-3 min-[1000px]:gap-4">
            ...
            <div className="scroll-reveal-scale col-span-2 flex flex-row overflow-hidden rounded-2xl border border-white/60 bg-white/70 shadow-lg backdrop-blur-xl transition-all hover:bg-white/80 hover:shadow-xl">
              ...
              <div className="flex w-[280px] shrink-0 items-center justify-center border-l border-white/40 bg-white/40 px-6">
          ...
          <div className="hidden min-[768px]:flex min-[768px]:flex-col min-[768px]:gap-4 min-[1000px]:hidden">
            ...
            <div className="scroll-reveal-scale flex flex-row overflow-hidden rounded-2xl border border-white/60 bg-white/70 shadow-lg backdrop-blur-xl transition-all hover:bg-white/80 hover:shadow-xl">
              <div className="flex flex-1 flex-col p-6">
              ...
              <div className="flex w-[240px] shrink-0 items-center justify-center border-l border-white/40 bg-white/40 px-5">
                <div className="flex w-full flex-col gap-3">
                  <div className="flex w-full items-center gap-3 rounded-xl border border-landing-coral/20 bg-landing-coral/5 px-3 py-3">
                    <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-landing-coral/20"><HelpCircle className="h-4 w-4 text-landing-coral" /></div>
          ...
          <div className="flex flex-col gap-4 min-[768px]:hidden">
            ...
            <div className="scroll-reveal-scale flex flex-col overflow-hidden rounded-2xl border border-white/60 bg-white/70 shadow-lg backdrop-blur-xl transition-all hover:bg-white/80 hover:shadow-xl min-[600px]:flex-row">
              ...
              <div className="flex items-center justify-center border-t border-white/40 bg-white/40 px-8 py-6 min-[600px]:w-[200px] min-[600px]:shrink-0 min-[600px]:border-t-0 min-[600px]:border-l">
